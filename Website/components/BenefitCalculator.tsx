    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6">
      <ScrollReveal animation="fade-in">
        <div className="bg-gradient-to-br from-purple-500/10 via-blue-500/5 to-pink-500/10 rounded-xl sm:rounded-2xl border border-purple-500/20 p-3 sm:p-4 md:p-6 backdrop-blur-sm">
          ...
          {/* Кнопка налогового вычета */}
          <div className="mt-6 sm:mt-8 pt-6 sm:pt-8 border-t border-border/30">
            <div className="text-center">
              <a
                href="/tax-deduction"
                className="inline-flex items-center gap-2.5 px-6 py-3 border border-purple-500/20 bg-gradient-to-r from-purple-500/5 to-blue-500/5 hover:from-purple-500/10 hover:to-blue-500/10 hover:border-purple-500/40 text-xs font-light text-foreground transition-all duration-300 uppercase tracking-wide rounded-lg backdrop-blur-sm group"
              >
                <svg 
                  className="w-4 h-4 text-purple-400 opacity-80 group-hover:opacity-100 transition-opacity" 
                  fill="none" 
                  stroke="currentColor" 
                  viewBox="0 0 24 24"
                >
                ...
                <span>Узнайте о налоговом вычете</span>
                <svg 
          ...
          <div className="mt-3 sm:mt-4 pt-3 sm:pt-4 border-t border-border/30">
            <p className="text-[9px] sm:text-[10px] text-muted font-light leading-snug">
              * Расчеты основаны на статистике: 68% клиентов получают оффер за 3 месяца. Процент повышения оффера зависит от
              выбранного тарифа (VIP: до 28.4%, Take All +: до 15.5%, Take All: до 6%). ** Экономия времени рассчитана как
              разница между средним временем самостоятельного поиска (6+ месяцев) и временем с Go Offer (3 месяца для 68%
              клиентов).
            </p>
          </div>
        </div>
