...
export default function Services() {
  ...
  const colorClasses = {
    purple: 'hover:border-purple-400/50 hover:bg-purple-500/5',
    blue: 'hover:border-blue-400/50 hover:bg-blue-500/5',
    pink: 'hover:border-pink-400/50 hover:bg-pink-500/5',
    cyan: 'hover:border-cyan-400/50 hover:bg-cyan-500/5',
    violet: 'hover:border-violet-400/50 hover:bg-violet-500/5',
  }

  return (
    <section id="services" className="py-16 md:py-20 border-t border-border relative">
